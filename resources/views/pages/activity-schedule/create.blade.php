                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="day" class="block mt-1 w-full rounded-xl" type="text"
                                    name="day" :value="old('day')" required readonly autocomplete="day" />
                            ...
                            <div>
                                ...
                                <x-text-input id="start_time" class="block mt-1 w-full rounded-xl" type="time"
                                    name="start_time" :value="old('start_time')" required autofocus autocomplete="start_time" />
                            ...
                            <div>
                                ...
                                <x-text-input id="end_time" class="block mt-1 w-full rounded-xl" type="time"
                                    name="end_time" :value="old('end_time')" required autofocus autocomplete="end_time" />
                                ...
                                <select name="lecturers[]" id="lecturers"
                                    ...
                                    @foreach ($lecturers as $lecturer)
                                        <option value="{{ $lecturer->id }}"
                                            {{ collect(old('lecturers'))->contains($lecturer->id) ? 'selected' : '' }}>
                                            {{ $lecturer->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="students[]" id="students" class="block w-full rounded-xl select2"
                                    ...
                                    @foreach ($students as $student)
                                        <option value="{{ $student->id }}"
                                            {{ collect(old('students'))->contains($student->id) ? 'selected' : '' }}>
                                            {{ $student->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-span-2">
                                ...
                                <x-text-input id="agenda" class="block mt-1 w-full rounded-xl" type="text"
                                    name="agenda" :value="old('agenda')" required autofocus autocomplete="agenda" />
